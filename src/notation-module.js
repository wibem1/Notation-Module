// Notation Module v0.1.1 — app-independent ABC rendering/playback core.
export class NotationModule {
  constructor({paper,onStatus=()=>{}}={}){this.paper=paper;this.onStatus=onStatus;this.abc='';this.visualObj=null;this.synth=null;this.revision=0;}
  ...
  async play(){
    ...
    if(revision!==this.revision||synth!==this.synth)return;
    if(primed?.status==='suspended'||primed?.status==='interrupted'){
